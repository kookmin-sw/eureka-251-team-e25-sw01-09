...
| **김세정** | 소프트웨어전공 | 보안, 프론트엔드, 백엔드, 인공지능 |
| **유장훈** | 인공지능전공 | 알고리즘, 시스템 프로그래밍, 스타트업 |
| **전서영** | 인공지능전공 | UX/UI, 모바일 앱, 창업 |
| **정연빈** | 인공지능전공 | 분산 시스템, 데이터베이스, 오픈소스 |
...
나인(nine)은 완전함과 도전 정신을 상징하며, 팀원이 서로 다른 관점과 강점을 지닌 9개의 코드 조각처럼 모여 하나의 완성된 솔루션을 만들어 간다는 의미를 담고 있습니다. 
